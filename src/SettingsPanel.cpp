    ...
    : wxPanel(parent, wxID_ANY)
{
    ...
    GSlider = new wxSlider(graphics, wxID_ANY, 100, 0, 100, wxPoint(120, 88), wxDefaultSize, 0, wxDefaultValidator,
                           wxSliderNameStr);

    B = new wxStaticText(graphics, wxID_ANY, "Blue", wxPoint(20, 120), wxDefaultSize, 0, wxStaticTextNameStr);
    BSlider = new wxSlider(graphics, wxID_ANY, 100, 0, 100, wxPoint(120, 118), wxDefaultSize, 0, wxDefaultValidator,
                           wxSliderNameStr);
