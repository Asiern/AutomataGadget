...
PlayerPanel::PlayerPanel(wxNotebook* parent, NieRHook* hook) : wxPanel(parent, wxID_ANY)
{
	this->hook = hook;
	//Const sizes
	const int margin = 10;
	...
	m_EXP = new wxStaticText(this, wxID_ANY, "EXP: 0", wxPoint(margin * 3, margin + 60), wxDefaultSize, 0, wxStaticTextNameStr);

	//Cheats
	m_CheatsBox = new wxStaticBox(this, wxID_ANY, "Cheats", wxPoint(margin, 110), wxSize(width - 30, 130), 1, wxStaticBoxNameStr);
	m_NoClip = new wxCheckBox(this, wxID_ANY, "No Clip", wxPoint(3 * margin, 140), wxDefaultSize, 0, wxDefaultValidator, wxCheckBoxNameStr);
	m_NoClip->Bind(wxEVT_CHECKBOX, &PlayerPanel::NoClip, this);
	m_SpeedHack = new wxCheckBox(this, wxID_ANY, "2x Speed", wxPoint(3 * margin, 170), wxDefaultSize, 0, wxDefaultValidator, wxCheckBoxNameStr);
	m_SpeedHack->Bind(wxEVT_CHECKBOX, &PlayerPanel::SpeedHack, this);
	m_InfDoubleJump = new wxCheckBox(this, wxID_ANY, "Infinite Double Jump", wxPoint(margin + (width - 2 * margin) / 2, 140), wxDefaultSize, 0, wxDefaultValidator, wxCheckBoxNameStr);
	m_InfDoubleJump->Bind(wxEVT_CHECKBOX, &PlayerPanel::InfDoubleJump, this);
	m_NoCooldown = new wxCheckBox(this, wxID_ANY, "No Cooldown", wxPoint(3 * margin, 200), wxDefaultSize, 0, wxDefaultValidator, wxCheckBoxNameStr);
	m_NoCooldown->Bind(wxEVT_CHECKBOX, &PlayerPanel::NoCooldown, this);
	m_InfAirDash = new wxCheckBox(this, wxID_ANY, "Infinite Air Dash", wxPoint(margin + (width - 2 * margin) / 2, 170), wxDefaultSize, 0, wxDefaultValidator, wxCheckBoxNameStr);
	m_InfAirDash->Bind(wxEVT_CHECKBOX, &PlayerPanel::InfAirDash, this);
	m_IgnoreUpgradeMaterials = new wxCheckBox(this, wxID_ANY, "Ignore Upgrade Materials", wxPoint(margin + (width - 2 * margin) / 2, 200), wxDefaultSize, 0, wxDefaultValidator, wxCheckBoxNameStr);
